...
const FRAGMENT_SHADER = /* glsl */ `
  ...
  void main() {
    ...
    vec3 baseColor = vec3(0.028, 0.036, 0.044);

    vec3 color = mix(baseColor, uMinorColor, minor * 0.65);
...
export function ConstructionGrid({
  ...
  viewport,
  viewportPlane
}: Pick<ViewportCanvasProps, "activeToolId" | "onPlaceAsset" | "sceneSettings" | "viewport" | "viewportPlane">) {
...
function GridShaderPlane({
  ...
  }, [minorColor, majorColor, minorStep, majorStep, fadeDist]);
